...
exports.PUBLIC_DIRECTORIES = void 0;
exports.PUBLIC_DIRECTORIES = {
    images: 'public/img/',
    backups: 'backups/',
...
const ALLOWED_EDITORS = ['webstorm', 'code', 'open'];
...
function init(router) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        router.post('/open', jsonParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const globalExtensions = node_fs_1.default
                    .readdirSync(constants_1.PUBLIC_DIRECTORIES.globalExtensions)
                    .filter(f => node_fs_1.default.statSync(node_path_1.default.join(constants_1.PUBLIC_DIRECTORIES.globalExtensions, f)).isDirectory());
                ...
                const extensionPath = node_path_1.default.join(constants_1.PUBLIC_DIRECTORIES.globalExtensions, extensionName, 'index.js');
                ...
                yield execAsync(`${editor} "${extensionPath}"`);
                ...
                const errorDetails = error instanceof Error
                    ? error.message
                    : (error === null || error === void 0 ? void 0 : error.stderr) || 'Unknown error';
        ...
        router.post('/create', jsonParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const extensionPath = node_path_1.default.join(constants_1.PUBLIC_DIRECTORIES.globalExtensions, name.replace(/[^a-zA-Z0-9-_]/g, ''));
                ...
                node_fs_1.default.writeFileSync(node_path_1.default.join(extensionPath, 'index.js'), indexContent);
